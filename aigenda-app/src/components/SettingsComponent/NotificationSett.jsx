...
const NotificationSett = ()=>{
    return(
        <div className="app-container">
          ...
          <SettSidebar/>
          {/* <div className="sett-notifi-container">
          ...
          <main className="sett-notifi-container">
            <div style={{maxWidth: "100%", margin: "0px", padding:'20px',backgroundColor:'#fafafa',border:'1px solid #eee9f9',borderRadius:'15px'}}>
              <div style={{marginBottom: "3rem"}}>
                <h2 style={{fontSize: "2rem", fontWeight: "700", marginBottom: "0.5rem"}}>Notifications Settings</h2>
                <p style={{color:" var(--text-muted)"}}>manage how and when you recieve alerts form our app</p>
              </div>
